...
[![Version](https://img.shields.io/badge/version-0.0.4-blue.svg)](https://github.com/flyhunterl/flymd)
...
- 即开即用：安装包仅5MB 拒绝臃肿。冷启动毫秒级响应，无启动画面/欢迎页 
...
2. 运行 `flymd_0.0.4_x64_setup.exe` 安装（文件名以实际发布为准）
3. 启动 flyMD，开始使用
